...
function ProjectCard({ p, i }) {
  ...
  return (
    <motion.article
      ...
      className={`group relative overflow-hidden rounded-[32px] glass gradient-border glow-hover ${
      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden">
        ...
        >
          <a
            ...
            className="sheen inline-flex h-10 w-10 items-center justify-center rounded-full text-white shadow-[0_8px_24px_-6px_rgba(124,58,237,0.8)]"
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="cv-auto relative isolate py-24 md:py-32" data-testid="projects-section">
      <Aurora className="opacity-60 [mask-image:radial-gradient(ellipse_at_top_right,black,transparent_70%)]" />
      <div className="mx-auto max-w-[1280px] px-6 md:px-10">
        <SectionHeading
          eyebrow="Selected Work"
          title="Projects that ship"
          accent="and feel cinematic."
          intro="A curated set of recent builds — interactions are designed first, then engineered to perform smoothly across devices."
        />
